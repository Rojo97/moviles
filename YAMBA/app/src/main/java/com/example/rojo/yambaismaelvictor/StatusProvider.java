...
public class StatusProvider extends ContentProvider {
    ...
    public String getType(@NonNull Uri uri) {
        switch (sURIMatcher.match(uri)) {
            case StatusContract.STATUS_DIR:
                Log.d(TAG, "gotType: vnd.android.cursor.dir/vnd.com.example.rojo.yambaismaelvictor.provider.status");
                return "vnd.android.cursor.dir/vnd.com.example.rojo.yambaismaelvictor.provider.status";
            case StatusContract.STATUS_ITEM:
                Log.d(TAG, "gotType: vnd.android.cursor.item/vnd.com.example.rojo.yambaismaelvictor.provider.status");
                return
                        "vnd.android.cursor.item/vnd.com.example.rojo.yambaismaelvictor.provider.status";
            default:
                throw new IllegalArgumentException("uri incorrecta: " + uri);
        }
    }
